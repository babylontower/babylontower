...
func FormatHelp() string {
	...
	sb.WriteString("  /myid              Display your public key (share this with contacts)\n\n")
	sb.WriteString("Contacts:\n")
	sb.WriteString("  /add <pubkey> [name]  Add a contact (pubkey in hex or base58)\n")
	sb.WriteString("  /list                 List all contacts\n\n")
	sb.WriteString("Messaging:\n")
	sb.WriteString("  /chat <contact>    Enter chat mode with a contact (by index or pubkey)\n")
	sb.WriteString("  /history <contact> [limit]  Show message history with a contact\n\n")
