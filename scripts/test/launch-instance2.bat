@echo off
REM Babylon Tower - Launch Instance 2 (Bob) - Batch File
REM This script launches the second instance for manual two-instance testing
REM
REM Usage:
REM   scripts\test\launch-instance2.bat [data_dir]
REM
REM Arguments:
...
if "%1"=="" (
    set "DATA_DIR=%PROJECT_ROOT%\test-data\instance2"
) else (
    set "DATA_DIR=%1"
)
...
echo   scripts\test\launch-instance1.bat
echo ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
echo.
