@echo off
REM Babylon Tower - Launch Instance 1 (Alice) - Windows
REM This script launches the first instance for manual two-instance testing
REM
REM Usage:
REM   launch-instance1.bat [data_dir]
REM
REM Arguments:
...
set "DEFAULT_DATA_DIR=%PROJECT_ROOT%\test-data\instance1"
...
echo   3. Run '/listen' to get your multiaddr
echo   4. Share your multiaddr with Instance 2 (Bob)
echo   5. On Instance 2, use: /connect ^<your_multiaddr^>
echo   6. Exchange public keys and add contacts: /add ^<pubkey^> Name
...
echo   scripts\tests\launch-instance2.bat
echo ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
echo.
